...
public class Model : MonoBehaviour {
    ...
    Vector3 shipStartPos = new Vector3(-3.5f, -1f, 0);
    Vector3 shipEndPos = new Vector3(0.4f, -1f, 0);
    Vector3 bankStartPos = new Vector3(-10f, -5f, 0);
    Vector3 bankEndPos = new Vector3(6.7f, -5f, 0);

    float gap = 1.2f;

    Vector3 priestsStartPos = new Vector3(-9.5f, 0.5f, 0);
    Vector3 priestsEndPos = new Vector3(14f, 0.5f, 0);
    Vector3 devilsStartPos = new Vector3(-5.7f, 0.5f, 0);
    Vector3 devilsEndPos = new Vector3(10f, 0.5f, 0);
